...
public class TeamService {
    ...
    @Transactional
    public TeamResponse updateStatus(
            Long id,
            UpdateTeamStatusRequest request
    ) {
    ...
    public void removeMember(
        ...
        if (competitor.getTeam() == null
            ...
            throw new BusinessRuleException(
                    "Competitor with ID "
                            + competitorId
                            + " does not belong to team with ID "
                            + teamId
            );
        }
    ...
    public void delete(Long id) {
        ...
        if (team.getMembers() != null
            ...
            throw new BusinessRuleException(
                    "Team with ID "
                            + id
                            + " cannot be deleted while it has members. "
    ...
    private Competitor findCompetitorById(
            UUID id
    ) {
    ...
    private void validateTeamCanReceiveMembers(
            Team team
    ) {
        ...
        if (competitor.getTeam() != null) {
            ...
            if (competitor.getTeam()
                ...
                throw new BusinessRuleException(
                        "Competitor with ID "
                                + competitor.getId()
                                + " already belongs to team with ID "
                                + team.getId()
                );
            }
    ...
    private void validateTeamCapacity(
        ...
        if (currentMembers >= maxMembers) {
            ...
            throw new BusinessRuleException(
                    "Team with ID "
                            + team.getId()
                            + " reached the maximum allowed number of members: "
                            + maxMembers
            );
        }
    }
